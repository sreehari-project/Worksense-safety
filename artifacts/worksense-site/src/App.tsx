      ...
      <div className="ws-container ws-header-inner">
        ...
        <nav className="ws-nav" aria-label="Main navigation">
          ...
          <div className="ws-header-socials" aria-label="Social links">
            <a href="https://www.facebook.com/share/1Ektkab1bB/" target="_blank" rel="noreferrer" aria-label="Facebook" data-testid="link-facebook">f</a>
            <a href="https://www.instagram.com/worksense_official" target="_blank" rel="noreferrer" aria-label="Instagram" data-testid="link-instagram">ig</a>
            <span className="ws-disabled-social" title="Coming Soon" aria-label="LinkedIn coming soon" data-testid="status-linkedin-coming-soon">in<small>Coming Soon</small></span>
          </div>
      ...
      <div className="ws-container">
        <div className="ws-footer-main">
          ...
          <div className="ws-footer-links">
            ...
            <div><span>Connect</span><Link href="/dashboard">Business Login</Link><a href="https://www.facebook.com/share/1Ektkab1bB/" target="_blank" rel="noreferrer">Facebook</a><a href="https://www.instagram.com/worksense_official" target="_blank" rel="noreferrer">Instagram</a><span className="ws-footer-disabled">LinkedIn <small>Coming Soon</small></span></div>
          </div>
        </div>
